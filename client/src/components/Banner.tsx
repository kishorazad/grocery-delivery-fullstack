...
const Banner = () => {
    ...
    return (
        <div>
            {bannerVisible && (
                <div className="bg-gradient-to-r from-green-700 via-emerald-700 to-green-800 text-white text-xs sm:text-sm relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">
                                Free medicine delivery on orders above ₹500
                            </span>
                        </div>
                        ...
                        <div className="hidden sm:flex items-center gap-2">
                            <ShieldCheckIcon className="size-4 text-green-200 shrink-0" />
                            <span>
                                100% genuine medicines from verified pharmacies
                            </span>
                        </div>
